...
.updated{margin:0;padding:8px 14px;align-self:stretch;border:1px solid var(--rule);
  border-left:3px solid var(--s1);background:var(--panel);border-radius:3px;
...
.stamp{font-family:var(--mono);font-size:11px;letter-spacing:.05em;color:var(--ink3);text-align:right;
  white-space:nowrap}
.panel{background:var(--panel);border:1px solid var(--rule);border-radius:10px;padding:16px 18px}
...
button{font:inherit;font-size:12.5px;font-weight:600;padding:7px 13px;border:1px solid var(--rule);
  border-radius:7px;background:var(--panel);color:var(--ink2);cursor:pointer}
...
.tip{position:absolute;pointer-events:none;background:var(--panel);border:1px solid var(--rule);
  border-radius:8px;padding:8px 11px;font-size:12.5px;box-shadow:0 4px 14px rgba(0,0,0,.13);
...
.sm figure{border:1px solid var(--rule2);border-radius:8px;padding:8px 8px 4px;background:var(--panel)}
...
.tscroll{max-height:390px;overflow:auto;border:1px solid var(--rule2);border-radius:8px}
...
.warn{background:var(--accentbg);border-left:3px solid var(--s1);padding:10px 13px;border-radius:0 7px 7px 0;
...
<section class="panel" style="display:flex;justify-content:space-between;align-items:center;gap:14px;flex-wrap:wrap">
  ...
  <a href="https://claude.ai/code/artifact/0c2545da-ee53-41ec-8763-583958244c94" target="_blank"
     ...
     border-radius:8px;color:var(--s1);text-decoration:none;white-space:nowrap">Open commentary &rarr;</a>
</section>
